...
1. Replace environment varaibles in the [`gordon-mcp.yml` file](https://docs.docker.com/ai/gordon/mcp/yaml/) with your Docker Hub username and a PAT token.
...
- **check_repository_tags** - Check if a repository contains any tags
  - `namespace`: Repository namespace (string, required)
  - `repository`: Repository name (string, required)
