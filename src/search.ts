...
const searchResult = z.object({
  ...
  name: z
    .string()
    .describe(
      "The name of the repository in the format of namespace/repository"
    ),
  ...
  created_at: z
    .string()
    .describe("The date and time the repository was created"),
  updated_at: z
    .string()
    .describe("The date and time the repository was last updated"),
  short_description: z
    .string()
...
export class Search extends Asset {
      ...
      "search",
      {
        ...
        inputSchema: {
          ...
          from: z
            .number()
            .optional()
            .describe("The number of repositories to skip"),
          size: z
            .number()
            .optional()
  ...
  private async search(request: {
    ...
    if (!request.query) {
      return {
        content: [
          { type: "text", text: "Please provide a query to search for" },
        ],
        structuredContent: {},
        isError: true,
      };
